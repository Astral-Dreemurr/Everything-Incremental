...
Stats=Button(text = 'Stats', background = 'green', command=Stattab)
Cores=Button(text = 'Cores', background = 'yellow', command=Coretab)
Milestones=Button(text = 'Milestones', background = 'yellow', command=Milestonetab)
Challenges=Button(text = 'Challenges', background = 'blue', command=Challengetab)
Informations=Button(text = 'Informations', background = 'grey', command=Informationtab)
Settings=Button(text = 'Settings', background = 'dark grey', command=Settingtab)
TuStTaQu=Button(text = 'Tutorials & Stories & Tasks & Quests', background = 'pink', command=TuStTaQutab)
OriginGame=Button(text = 'Original Games List', background = 'light blue', command=OriginGameInfo)
